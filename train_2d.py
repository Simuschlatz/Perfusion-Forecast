...
from perfusionforecast import config_map_2d
from perfusionforecast.models_2d import model_map
from perfusionforecast.utils import seed_everything, VolumeDataModule2D
from perfusionforecast.models_2d import Pl_Model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpu", type=int, default=0, help="Number of gpu the model runs on")
    ...
    input_shape = [args.input_frames, 1, 256, 256]
    if args.model_name in config_map_2d:
        config_fn = config_map_2d[args.model_name]
        ...
        raise ValueError(f"Model '{args.model_name}' is not a valid option. Available: {list(config_map_2d.keys())}")

    run_name = args.model_name
    run_name = "2D-" + run_name
